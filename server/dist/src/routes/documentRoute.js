...
router.get("/children/:childId/documents", getDocuments);
// Get one document
router.get("/documents/:id", getDocumentById);
// Upload document
router.post("/children/:childId/documents", uploadDocument.single("file"), createDocument);
// Update document / optionally replace file
router.put("/documents/:id", uploadDocument.single("file"), updateDocument);
// Delete document
