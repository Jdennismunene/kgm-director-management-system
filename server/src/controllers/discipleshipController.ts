...
export const getDiscipleshipRecords = async (req: Request, res: Response) => {
  try {
...
export const createDiscipleshipRecord = async (req: Request, res: Response) => {
  try {
    const childId = String(req.params.childId);

    const { type, title, description, date, completed, mentor, notes } =
      req.body;
...
export const updateDiscipleshipRecord = async (req: Request, res: Response) => {
  try {
    const childId = String(req.params.childId);
    const id = String(req.params.id);
...
export const deleteDiscipleshipRecord = async (req: Request, res: Response) => {
  try {
    const childId = String(req.params.childId);
    const id = String(req.params.id);
...
export const getSpiritualDevelopment = async (req: Request, res: Response) => {
  try {
    const childId = String(req.params.childId);
