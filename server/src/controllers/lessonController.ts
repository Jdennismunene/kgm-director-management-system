...
export const getChildLessons = async (req: Request, res: Response) => {
  try {
...
export const createLesson = async (req: Request, res: Response) => {
  try {
    const { childId, title, category, date, progress, status, score, teacher } =
      req.body;
...
export const updateLesson = async (req: Request, res: Response) => {
  try {
    ...
    const { title, category, date, progress, status, score, teacher } =
      req.body;
    ...
    const lesson = await prisma.lesson.update({
      ...
      data: {
        ...
        score:
          finalStatus === "COMPLETED" ? (score ?? existingLesson.score) : null,
