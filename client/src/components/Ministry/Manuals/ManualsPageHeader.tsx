...
interface ManualsPageHeaderProps {
  onAddManual?: () => void;
}

const ManualsPageHeader = ({ onAddManual }: ManualsPageHeaderProps) => {
  return (
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Manage teaching manuals and Christian education resources used by
            ministry teachers.
          </p>
        </div>
      </div>
...
export default ManualsPageHeader;
