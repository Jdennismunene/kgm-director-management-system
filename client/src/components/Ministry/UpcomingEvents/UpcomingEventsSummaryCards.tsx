...
interface UpcomingEventsSummaryCardsProps {
...
const UpcomingEventsSummaryCards = ({
  totalUpcoming,
  thisMonth,
  thisWeek,
  totalParticipants,
}: UpcomingEventsSummaryCardsProps) => {
  const cards = [
    {
    ...
    },
    {
      ...
      description: "Expected attendance across events",
      icon: Users,
...
export default UpcomingEventsSummaryCards;
