...
interface UpcomingEventsPageHeaderProps {
  onAdd: () => void;
}

const UpcomingEventsPageHeader = ({ onAdd }: UpcomingEventsPageHeaderProps) => {
  return (
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            View and manage upcoming church events and activities.
          </p>
        </div>
      </div>
...
export default UpcomingEventsPageHeader;
