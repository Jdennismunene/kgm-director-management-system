...
interface AddTeachersSeminarModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAdd: (seminar: TeacherSeminar) => void;
}

const AddTeachersSeminarModal = ({
  isOpen,
  onClose,
  onAdd,
}: AddTeachersSeminarModalProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newSeminar: TeacherSeminar = {
      id: Date.now(),
      title: title.trim(),
      year,
      startDate,
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                Add Teachers Seminar
              </h2>

              <p className="text-sm text-gray-500 dark:text-gray-400">
                Add a new seminar record.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-5 p-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Annual Teachers Seminar"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe the purpose or activities of the seminar..."
...
export default AddTeachersSeminarModal;
