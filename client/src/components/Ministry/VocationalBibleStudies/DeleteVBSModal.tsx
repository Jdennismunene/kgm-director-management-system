          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-4 text-sm leading-5 text-gray-500 dark:text-gray-400">
                This action cannot be undone. The VBS record and its information
                will be removed from the current records.
              </p>
            </div>
          </div>
        </div>
