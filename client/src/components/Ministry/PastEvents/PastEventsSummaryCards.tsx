...
interface PastEventsSummaryCardsProps {
...
const PastEventsSummaryCards = ({
  totalPastEvents,
  thisMonth,
  thisYear,
  totalParticipants,
}: PastEventsSummaryCardsProps) => {
  const cards = [
    {
      title: "Past Events",
      value: totalPastEvents,
      description: "All completed events",
      icon: CalendarCheck,
    ...
    },
    {
      title: "This Year",
      value: thisYear,
      description: "Events completed this year",
      icon: CalendarDays,
...
export default PastEventsSummaryCards;
